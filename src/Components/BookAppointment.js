...
import Doctor from "../Assets/info.png";
    ...
    <div className="ba-section">
      ...
      <div className="ba-text-content">
        ...
        <p className="ba-description">
          Discover the reasons to choose Satyam for your healthcare
          needs.Experience expert care, convenience, and personalized solutions,
